...
C. RUNNING THE EXECUTABLES 
  ...
  1. Triangulation matting 
     ...
     viscomp.py --matting \
                --backA ../test-images/tiny/colourful-backA.jpg \
                --backB ../test-images/tiny/colourful-backB.jpg \
                --compA ../test-images/tiny/colourful-compA.jpg \
                --compB ../test-images/tiny/colourful-compB.jpg \
                --alphaOut alpha.tif \
                --colOut col.tif


    viscomp.py --matting \
                --backA ../test-images/tiny/colone_window-backA.JPG \
                --backB ../test-images/tiny/colone_window-backB.JPG \
                --compA ../test-images/tiny/colone_window-compA.JPG \
                --compB ../test-images/tiny/colone_window-compB.JPG \
                --alphaOut alpha.tif \
                --colOut col.tif

    viscomp.py --matting \
                --backA ../test-images/tiny/dark1.jpg \
                --backB ../test-images/tiny/dark2.jpg \
                --compA ../test-images/tiny/dark3.jpg \
                --compB ../test-images/tiny/dark4.jpg \
                --alphaOut alpha.tif \
                --colOut col.tif
